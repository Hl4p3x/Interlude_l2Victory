...
DELETE FROM character_shortcuts WHERE object_id NOT IN (SELECT obj_Id FROM characters);
...
DELETE FROM pets WHERE item_obj_id NOT IN (SELECT item_id FROM items);
...
DELETE FROM oly_heroes WHERE char_id NOT IN (SELECT obj_Id FROM characters);
DELETE FROM oly_nobles WHERE char_id NOT IN (SELECT obj_Id FROM characters);
